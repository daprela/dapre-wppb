...
class Dapre_Wppb {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Dapre_Wppb_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Dapre_Wppb_Loader. Orchestrates the hooks of the plugin.
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-dapre-wppb-loader.php';
		...
		$this->loader = new Dapre_Wppb_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Dapre_Wppb_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Dapre_Wppb_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Dapre_Wppb_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Dapre_Wppb_Loader    Orchestrates the hooks of the plugin.
	 */
